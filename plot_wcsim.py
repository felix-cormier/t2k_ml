...
def plot_wcsim(input_path, output_path, wcsim_options, text_file=False):
    ...
    generic_histogram(wall, 'Wall [cm]', output_path, 'wall', y_name = yname, label=label, bins=20)
    generic_histogram(towall, 'Towall [cm]', output_path, 'towall', y_name = yname, label=label, bins=20)
