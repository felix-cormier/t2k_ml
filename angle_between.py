...
def angle_hist(a, bins = None, xlimit = None, name = None, title = None):
    ...
    plt.savefig('/fast_scratch/ipress/egamma/angles'+str(name)+'.png')
    plt.close()
...
def distance_hist(a, bins = None, xlimit = None, name = None, title = None):
    ...
    RMS_a = rms(a)
    RMS_b = rms(b)
    plt.text(mean_a, 0, f'mean_gamma = {mean_a}\nmean_electron = {mean_b}\nRMS_gamma = {RMS_a}\nmean_electron = {RMS_b}')
    plt.title(r'Distance between e$^{-}$/e$^{+}$ pair production at end'+str(title))
    plt.savefig('/fast_scratch/ipress/egamma/distance'+str(name)+'.png')
    plt.close()
...
def hits_hist(a, b, bins = None, xlimit = None, name = None, title = None):
    ...
    hist_a = ax.hist(a, bins, range = xlimit, align = 'mid', density = True, alpha = 0.5, label = 'Gamma hits')
    ...
    ax.plot([], [], ' ', label=f"Mean_gamma = {mean_a}")
    ax.plot([], [], ' ', label=f"Mean_electron = {mean_b}")
    ax.plot([], [], ' ', label=f"STD_gamma = {std_a}")
    ax.plot([], [], ' ', label=f"STD_electron = {std_b}")
    ax.legend()
    ax.set_title(r'Hits for gammas and electrons at energies '+str(title))
    plt.savefig('/fast_scratch/ipress/egamma_constrained/plots/plot_hits_'+str(name)+'.png')
    plt.close()
...
def charge_hist(a, b, bins = None, xlimit = None, name = None, title = None):
    ...
    std_a = np.round(np.std(a))
    std_b = np.round(np.std(b))
    #ax.text(mean_a, 0, f'mean_gamma = {mean_a}\nmean_electron = {mean_b}\nRMS_gamma = {RMS_a}\nmean_electron = {RMS_b}')
    ax.plot([], [], ' ', label=f"Mean_gamma = {mean_a}")
    ax.plot([], [], ' ', label=f"Mean_electron = {mean_b}")
    ax.plot([], [], ' ', label=f"STD_gamma = {std_a}")
    ax.plot([], [], ' ', label=f"STD_electron = {std_b}")
    ax.legend()
    ax.set_title(r'Total charge for gammas and electrons at energies '+str(title))
    plt.savefig('/fast_scratch/ipress/egamma_constrained/plots/plot_charge_'+str(name)+'.png')
    plt.close()
...
def time_hist(a, b, bins = None, xlimit = None, name = None, title = None):
    ...
    fig = plt.figure()
    ax = fig.add_subplot(111)
    ax.hist(a, bins, range = xlimit, density = True, alpha = 0.5, label = 'Gamma hits')
    ...
    ax.plot([], [], ' ', label=f"STD_electron = {std_b}")
    ax.legend()    
    ax.set_title(r'Average time for gammas and electrons at energies '+str(title))
    plt.savefig('/fast_scratch/ipress/egamma_constrained/plots/plot_time_'+str(name)+'.png')
    plt.close()
