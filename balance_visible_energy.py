...
def balance_visible_energy(input_path, output_path=None, text_file=False, overwrite=False): 
    ...
    Args:
        ...
        output_path (str, optional): Where to save new .hy file that is more balanced in truth visible energy. 
                                     ...
                                     path as the input file path but with an appended '_balanced' before the .hy.
    ...
    for i, path in enumerate(input_path):
        ...
        # otherwise create copy of the input file and add the 'keep_event' key to the copy
            ...
            if output_path == None:
                output_path = path.split('.hy')[0] + '_balanced.hy'
            ...
            with h5py.File(path+'/digi_combine.hy', mode='r') as h5fw:
                ...
                with h5py.File(output_path+f'/digi_combine_balanced_{i}.hy', 'w') as new_h5fw:
...
if __name__ == '__main__':
    truth_visible_energy, label, min_bin_fill = balance_visible_energy(input_path='plotting_paths.txt', 
                                                                       output_path=None, 
